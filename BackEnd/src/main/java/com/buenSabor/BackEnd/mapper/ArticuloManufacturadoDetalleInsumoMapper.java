...
public interface ArticuloManufacturadoDetalleInsumoMapper {
    ...
    // ==>{ArticuloManufacturadoDetalleInsumo entity, y lo que ignora
    // *articuloManufacturado,id,articuloInsumo*}
    ...
    @Mapping(target = "articuloManufacturado", ignore = true)
    @Mapping(target = "articuloInsumo", ignore = true)
    void updateFromDto(ArticuloManufacturadoDetalleInsumoDTO dto,
            @MappingTarget ArticuloManufacturadoDetalleInsumo entity);
}
